		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales App",
									"targetURL": "#sapbtpprojectsapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpprojectsapui5-display": {
								"semanticObject": "sapbtpprojectsapui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.projectsapui5",
									"url": sap.ui.require.toUrl("sap/btp/projectsapui5")
								}
							}
						}
					}
